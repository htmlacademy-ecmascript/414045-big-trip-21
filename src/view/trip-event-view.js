...
function createTemplate(tripEvent, offers, destination) {
  return (
...
export default class TripEventView {
  constructor({tripEvent, offers, destination}) {
  ...
  getTemplate() {
    return createTemplate(this.tripEvent, this.offers, this.destination);
  }
